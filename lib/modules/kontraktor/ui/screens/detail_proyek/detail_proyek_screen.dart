...
import 'widgets/detail_proyek_title_card.dart';
import 'widgets/detail_proyek_client_info.dart';
import 'widgets/detail_proyek_description.dart';
import 'widgets/detail_proyek_technical_specs.dart';
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                DetailProyekTitleCard(project: widget.project, bidCount: _bidCount),
                const SizedBox(height: 16),
                DetailProyekClientInfo(project: widget.project, bidCount: _bidCount),
                const SizedBox(height: 20),
                DetailProyekDescription(project: widget.project),
                const SizedBox(height: 20),
                DetailProyekTechnicalSpecs(project: widget.project),
